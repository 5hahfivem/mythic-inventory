...
_itemsSource["misc"] = {
	...
	{
		name = "lrgdoughat",
		label = "Doug Dimmadome",
		description = 'Doug\'s BIG Hat',
		price = 50,
		isUsable = true,
		isRemoved = true,
		isStackable = false,
	...
	},
	{
		name = "conehat",
		label = "Cone",
		description = 'Wearing a cone because sometimes, pointing in one direction is all you need in life!',
		price = 50,
		isUsable = true,
		isRemoved = true,
		isStackable = false,
	...
	},
	{
		name = "pd_duress_btn",
		label = "PD Panic Btn",
		iconOverride = 'duress_btn_01',
		description = "Emergency Duress Button for Law Enforcement Agencys",
		price = 0,
		isUsable = true,
		isRemoved = false,
		isStackable = false,
	...
	},
	{
		...
		label = "EMS Panic Btn",
		iconOverride = 'duress_btn_01',
		description = "Emergency Duress Button for Emergency Medical Services",
		price = 0,
		isUsable = true,
		isRemoved = false,
		isStackable = false,
	...
	{
		name = 'underground_pass',
		label = 'Unknown Pass',
		description = '"Lets Meet Underground" inscribed on the back',
		iconOverride = 'RacePassShop',
		price = 0,
		isUsable = false,
		isRemoved = false,
		isStackable = false,
